...
export function Footer() {
  return (
    <footer className="border-t border-[#222222] bg-[var(--color-surface)] py-12 md:py-16 relative overflow-hidden mt-10">
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-40 bg-brand-primary/[0.05] blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-8 mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="mailto:eduhlourenco2004@gmail.com" className="group flex items-center gap-3 text-sm text-[#D1D5DB] hover:text-[#FFFFFF] transition-colors">
              <div className="p-2 rounded-lg bg-[#111827] border border-[#222222] shadow-sm group-hover:border-brand-primary/40 group-hover:text-brand-primary transition-all">
        ...
        <div className="h-px bg-gradient-to-r from-transparent via-[#333333] to-transparent mb-6" />
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              onClick={scrollToTop}
              className="group p-2 rounded-lg border border-[#222222] bg-[#111827] shadow-sm hover:border-brand-primary/40 hover:text-brand-primary text-[#D1D5DB] transition-all"
